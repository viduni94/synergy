...
ComplexContractContext.prototype.accept = function(visitor) {
    if ( visitor instanceof hcclVisitor ) {
        return visitor.visitComplexContract(this);
    } else {
...
BasicContractContext.prototype.accept = function(visitor) {
    if ( visitor instanceof hcclVisitor ) {
        return visitor.visitBasicContract(this);
    } else {
        return visitor.visitChildren(this);
    }
};
...
ONEContext.prototype.Currency = function() {
